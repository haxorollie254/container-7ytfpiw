...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-7ytfpiw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-7ytfpiw.containers.anotherwebservice.com/
...
```
git clone git@github.com:haxorollie254/container-7ytfpiw.git
cd container-7ytfpiw
```
...
```
docker attach container-7ytfpiw
```
